...
urlpatterns = [
    ...
    path('api/trainees/', TraineeListView.as_view(), name='trainee-list'),
    path('api/trainees/<int:pk>/', TraineeDetailView.as_view(), name='trainee-detail'),
    path('api/trainees/<int:pk>/update/', update_trainee, name='update-trainee'),
